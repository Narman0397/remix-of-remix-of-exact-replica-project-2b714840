    ...
    items: [
      {
        ...
        desc: "Mode akses, kebijakan global, dan pengaturan inti.",
        icon: Settings,
      },
      {
        to: "/admin/governance",
        label: "Tata Kelola Sistem",
        desc: "Ringkasan governance dan skor kesehatan produksi.",
        icon: ShieldCheck,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        to: "/admin/system/uat",
        label: "UAT",
        desc: "Skenario User Acceptance Testing dan hasilnya.",
        icon: ListChecks,
      },
    ],
  },
