    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Mutasi, pemeliharaan, depresiasi nilai buku, dan cetak label QR aset.
        </p>
      </div>
      <div className="flex flex-wrap gap-2 border-b border-border">
        ...
        <TabBtn
          active={tab === "nilai_buku"}
          onClick={() => setTab("nilai_buku")}
          ...
          {rows.map((r) => (
            <tr key={r.id}>
              ...
              <td className="px-3 py-2 text-right text-xs">
                {r.nilai_perolehan
                  ? `Rp ${Number(r.nilai_perolehan).toLocaleString("id-ID")}`
                  : "—"}
              </td>
              ...
              <td className="px-3 py-2 text-right text-xs font-semibold">
                {r.nilai_buku !== null
                  ? `Rp ${Number(r.nilai_buku).toLocaleString("id-ID", { maximumFractionDigits: 0 })}`
                  : "—"}
              </td>
            </tr>
          ))}
