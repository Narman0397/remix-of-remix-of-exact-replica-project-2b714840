...
export const Route = createFileRoute("/_authenticated/admin/izin")({
  head: () => ({
    meta: [{ title: "Kelola Pengajuan Izin ASN" }, { name: "robots", content: "noindex" }],
  }),
  component: () => (
    <AdminGuard>
      <Page />
...
function Page() {
  ...
  const [status, setStatus] = useState<"pending" | "approved" | "rejected" | "dibatalkan" | "">(
    "pending",
  );
                      ...
                      {r.status === "pending" ? (
                        <div className="flex gap-2">
                          <button
                            ...
                            className="h-8 rounded-md bg-success/15 px-3 text-xs font-semibold text-success disabled:opacity-50"
                          >
                            Setujui
                          </button>
                          <button
                            ...
                            className="h-8 rounded-md bg-destructive/15 px-3 text-xs font-semibold text-destructive disabled:opacity-50"
                          >
                            Tolak
                          </button>
                        </div>
