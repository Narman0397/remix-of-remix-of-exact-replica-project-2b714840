...
export const Route = createFileRoute("/_authenticated/admin/asn/cuti-saldo")({
  ...
  component: () => (
    <AdminGuard>
      <AdminShell breadcrumb={[{ label: "Admin" }, { label: "Saldo Cuti" }]}>
        <Page />
      </AdminShell>
    </AdminGuard>
  ),
...
function Page() {
  ...
  return (
    <div className="space-y-4">
      <Card>
        <CardHeader>
          <CardTitle>Set Saldo Cuti</CardTitle>
        </CardHeader>
        <CardContent className="grid gap-2 sm:grid-cols-5">
          ...
          <Input
            ...
            placeholder="Jenis (tahunan, sakit, …)"
          />
          <Input
            type="number"
            min={0}
      ...
      <Card>
        <CardHeader>
          <CardTitle>Saldo Tahun {tahun}</CardTitle>
        </CardHeader>
        <CardContent>
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b">
                <th className="py-2 text-left">Pegawai</th>
                <th>Jenis</th>
                <th>Kuota</th>
                <th>Terpakai</th>
                <th>Sisa</th>
