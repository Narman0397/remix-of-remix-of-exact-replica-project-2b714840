...
export const Route = createFileRoute("/_authenticated/asn/lembur")({
  ...
  component: () => (
    <AdminGuard>
      <AdminShell breadcrumb={[{ label: "ASN" }, { label: "Lembur" }]}>
        <Page />
      </AdminShell>
    </AdminGuard>
  ),
...
function Page() {
  ...
  return (
    <div className="space-y-4">
      <Card>
        ...
        <CardContent className="space-y-2">
          ...
          <textarea
            ...
            rows={3}
            maxLength={1000}
            placeholder="Alasan lembur (min 10 karakter)…"
      ...
      <Card>
        <CardHeader>
          <CardTitle>Riwayat Lembur Saya</CardTitle>
        </CardHeader>
        <CardContent>
