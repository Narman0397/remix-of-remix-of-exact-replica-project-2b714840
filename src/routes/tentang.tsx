...
export const Route = createFileRoute("/tentang")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Visi, misi, struktur organisasi, dan profil Pemerintah Kabupaten Buton Selatan.",
      },
      ...
      <section className="container-page py-10 sm:py-14">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-border bg-card p-8 shadow-soft">
            ...
            <p className="mt-3 text-muted-foreground text-justify">
              5.257 ASN melayani warga di 42 Organisasi Perangkat Daerah (OPD) di Kabupaten Buton
              Selatan yang mencakup berbagai dinas, badan, dan kantor yang tersebar di lingkungan
              pemerintah daerah, 7 kecamatan, dan 70 desa/kelurahan, didukung sistem manajemen
