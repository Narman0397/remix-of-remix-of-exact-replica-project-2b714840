  ...
  head: () => ({
    meta: [
      { title: "Berita & Pengumuman — Pemerintah Kabupaten Buton Selatan" },
      {
        name: "description",
        content:
          "Berita resmi, pengumuman, dan agenda kegiatan Pemerintah Kabupaten Buton Selatan.",
      },
                ...
                {featured.gambar_url ? (
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[..."INFO"].slice(0, 3).map((c, i) => (
                      <div
                        key={i}
                        className="flex h-20 w-20 items-center justify-center rounded-xl bg-white/15 font-display text-3xl font-bold backdrop-blur"
                      >
                        {c}
                      </div>
                    ))}
